...
# shapes -- (4,16), (4,32), (4,63) -- used to xfail because rescale_stl_for_dtype
# derived the stick count from the input's padded stick *capacity*, which floors to
# a zero-sized dim on a sub-stick widening conversion (issue #4392). The count is
# now taken from the logical stick extent, so they pass.
